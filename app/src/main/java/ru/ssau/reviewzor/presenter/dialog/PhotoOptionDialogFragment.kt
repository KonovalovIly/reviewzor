package ru.ssau.reviewzor.presenter.dialog
...
import ru.ssau.reviewzor.presenter.screen.PlaceDetailFragment
...
class PhotoOptionDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        listener = parentFragment  as PhotoOptionDialogListener
